...
//     const innerText = e.target.innerText;
//     if (innerText || isGameOver|| isGameOver) return;
//     if(player === "player_1"){
//         e.target.innerText = "X";
//         player = "player_2";
//     }else{
...
const showGameOver = (char) =>{
    document.getElementById("winner").innerText = "Winner is "+char === "X" ? "player_1" : "player_2"
}
...
if(getValue("square_3") === char && getValue("square_3") === char && getValue("square_7") === char){
    isGameOver = true;
    showGameOver(char);
    return true;
}
